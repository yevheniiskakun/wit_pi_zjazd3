...
from . import views
#from .views import ProductViewSet, ProductDelete, MarkProduct, ProductAdd, ProductAPIDetailView
from .views import ProductViewSet, ProductAdd, ProductAPIDetailView
...
urlpatterns = ([
	...
	path('api/product_details/<int:pk>', ProductAPIDetailView.as_view(), name="product_details")
]
